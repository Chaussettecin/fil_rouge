...
public class battleNode extends node {
	  ...
	  private ArrayList<enemys.enemyNormal> listCultiste;
	  private ArrayList<enemys.enemyBoss> listBoss;
	 
	  private node winNext, loseNext;
	  private boolean startAtRange;

//-- Constructor -- 
	  public battleNode (ArrayList<listCultiste> listCultiste, 
