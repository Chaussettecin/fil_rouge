...
public class perso_creatures{
	
	   protected String nom;
	   protected ArrayList<ArmesMelees> armesMelees;
	   protected ArrayList<ArmesContact> armesContact;
	   protected ArrayList<Sorts> sorts;
	   protected ArrayList<Armures> armures;
	   ...
	   public perso_creatures(String tempNom, ArmeMelee[] temparmeMelee, 
			   					ArmesDistance[] temparmesDistance, Sorts[] tempSorts, Armures[] tempArmure, 
		...
		nom = tempNom;
		armeMelee = new ArrayList<ArmeMelee>(Arrays.asList(temparmeMelee));
		armesDistance = new ArrayList<ArmesDistance>(Arrays.asList(temparmesDistance));
		sorts = new ArrayList<Sorts>(Arrays.asList(tempSorts));
		armures = new ArrayList<Armures>(Arrays.asList(tempArmure));
		taille = tempTaille;
