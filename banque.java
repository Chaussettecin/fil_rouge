...
//--Verifier que le joueur est bien au niveau 2 
    if (joueurs_xp.getLevel() < 2) {
        ui.msg("");
        return;
    }
    ...
    private static void depot(int montant, double interet) {
        ...
        //repcup les stats 
        stats.totalGoldDepenser += Math.round(interet);
        stats.golddepenserInteret += Math.round(interet);
