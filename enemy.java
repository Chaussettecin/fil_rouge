...
//-- Constructor -
    public enemy(String nom, int level,Race race,int ptv, boolean dead, int attaque,
    			int bonusAttaque,int defense,int bonusDefense, int XP, int maxXP,
    			  int previousXP, int degat, int soin, int accuracy,  int minDamage,int maxDamage,
...
//--- Battle  -- 
  	public void attaqueBase( perso perso){
  		...
  		System.out.println(perso + " frappe " + perso + "pour "
  	...
  	/*private void performAction(){
        battleAction.baston(null, enemyBoss());
    };*/
...
//--Set : utilise pour changer la santé et les mana de l'enemis -- 
  	 ...
  	 public static int getActuelleSante() {return ptv; }
...
//--Définit et met à l'échelle les statistiques de l'ennemi en fonction de son type 
	...
	public static int getBonusDefense() {return bonusDefense; }
		
	public static void setBonusDefense(int bonusDefense) {
		enemy.bonusDefense = bonusDefense;
	}
   
	public String getNom(String text) { return nom; }
