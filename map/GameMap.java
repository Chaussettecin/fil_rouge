...
//--- weather of map --
    ...
    public ArrayList<Item> itemsObtained;
    ...
    public GameMap(screen.GameScreen gameScreen, Player player, ResourceManager rm) {
...
//-- J'avais fait le delire avec la mete --
...
// -- Sets dark of the map ---
    public void setDarkness(boolean isDark) {
        this.isDark = isDark;
        renderLight = isDark;
    }

//---- Calcule les penalité dûe à des morts. Avec le message qui va avec. --
