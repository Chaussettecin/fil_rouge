...
public class Tile {
    ...
    public static byte CHANGE = 2;
    public static byte IN_AND_OUT = 3;
    public static byte STOP = 4;
    public static byte DOWN = 5;
    public static byte UP = 6;
    public static byte RIGHT = 7;
    public static byte LEFT = 8;
    public static byte QUESTION_MARK = 9;
    public static byte ICE = 10;
    public static byte TELEPORT = 11;
    public static byte EXCLAMATION_MARK = 12;
    public static byte END = 13;
...
//-- A regular non-animated tile
    ...
    // An animated tile
    		...
    		// --@param anim
    		// -- @param tilePosition
    public Tile(int id, ActionManager anim, Vector2 tilePosition) {
