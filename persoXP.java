		 ...
		 public static void useSoin(String t) {
		    ...
		    // ui.cls();
		     ...
		     if (get(trouver) <= 0) {
		    	 ...
		    	 System.out.print("-------------------------------------------------------");
		    	 System.out.print("Tu es déjà en pleine forme ! Tu n'est pas un chat");
		    	 System.out.print("Donc tu n'as pas besoin d'utiliser " + trouver + " potion!");
		    	 System.out.print("-------------------------------------------------------");
		    	 System.out.print("Ta santé actuelle :  " + perso_sante.getStr());
		         ...
		         System.out.print("Te voilà en pleine forme avec : " + soin + " sante.	");
		         System.out.print("----------------------------------------------------");
		         System.out.print("Ta santé est de: " + perso_sante.getStr());
		         System.out.print(trouver + " Potions: " + get(trouver));
		         System.out.print("----------------------------------------------------");
		         //ui.pause();
		     }
