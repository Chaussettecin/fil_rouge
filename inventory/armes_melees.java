...
//--Constructor - 
	public armes_melees(String tempNom, String tempDescription, boolean tempPlural, 
						int tempDes, int tempAdd,int tempMinDext,
						int tempPrix, boolean tempTwoHands) {
		
				super(tempNom, tempDescription, tempPlural, tempDes, tempAdd, 
						tempPrix, tempTwoHands);
	...
	public static ArrayList<armes_melees> getAll(){ 
		...
		return new ArrayList<armes_melees>(
				...
				Arrays.asList(new armes_melees[]{
						dirk(utilsGame.playerAdjectives()), 
						epeeCourte(utilsGame.playerAdjectives()),		
						grall(utilsGame.playerAdjectives()),
						epeeMagique(utilsGame.playerAdjectives()),
						baton(utilsGame.playerAdjectives()),
