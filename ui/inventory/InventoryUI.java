 ...
 */
    ...
    private String[] headerStrs = { "STATUS", "EQUIPEMENT", "INVENTAIRE" };
    // stats labels
    ...
    // constants
    private static int SLOT_WIDTH = 16;
    private static int SLOT_HEIGHT = 16;
    private static Rectangle EQUIPS_AREA = new Rectangle(11, 11, 69, 57);
    private static Rectangle INVENTORY_AREA = new Rectangle(90, 14, 96, 64);
    ...
    public InventoryUI(final RPG game, Player player, final ResourceManager rm) {
...
//-- Reset les objets --
    ...
    // -- Ajoute un event quand un objet est mis dans l'inventaire - 
...
//--- Update joueur stat and gold - 
    private void updateText() {
        // update all text
        headers[0].setText("LV. " + Player.getLevel() + " JOUEUR");
        stats[0].setText("XP: " + Player.getHp() + "/" + Player.getMaxHp());
        stats[1].setText("Degats : " + Player.getMinDamage() + "-" + Player.getMaxDamage());
        stats[2].setText("ACCURACY: " + Player.getAccuracy() + "%");
        stats[3].setText("XP: " + Player.getExp() + "/" + Player.getMaxExp());
