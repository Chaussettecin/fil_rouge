...
//-- Affiche les barres de santé, les animations de combat, les animations de mouvement, etc.

public class BattleScene extends BattleUI {

    private Stage stage;
    
//--- Bar de santé Health bars
//--player --
...
// Battle scene sprite positions
 ...
 // battle animations
    ...
    public BattleScene(GameScreen gameScreen, Player player, Battle battle,
                       BattleUIHandler uiHandler, Stage stage, ResourceManager rm) {
        super(gameScreen, player, battle, uiHandler, rm);
