...
//-- L’écran qui apparaît après que le joueur ait terminé un niveau avec succès
		//--Affiche le temps d'achèvement, l'or obtenu, les objets obtenus, les exp obtenus, etc.
...
//-- Test banniere
   ...
   // private Label nextLabel;
    ...
    public VictoryScreen(RPG game, ResourceManager rm) {
		super(game, rm);
   ...
   /* public VictoryScreen(final Unlucky game, final ResourceManager rm) {
        ...
        bannerBg = new Image(Image, "default-slider");
