...
public abstract class combat_attaque {
	...
	public combat_attaque(String tempNom, String tempDescription, boolean tempPlural, int tempDes, 
	...
	public abstract boolean peutUtiliser(perso_ennemis e);
		
	public combat_degats degats(perso_ennemis e) {
		...
		if(peutUtiliser(e)) {
		    ...
		    return new combat_degats (desTotal + add, blesser);
		  }
		  return new combat_degats(0, 0);
		}
