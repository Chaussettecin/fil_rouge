...
//-- Constructor - 
		public creature_races(String id, String name, int level, Race race, int ptv, 
				...
				int XP, int maxXP, int previousXP, int degat, int soin, int accuracy, int minDamage,
				int maxDamage, statusEffect statusEffects, int manaMax, int powerMax, int lifeMax) {
		
			
			super (id, level, race, ptv, dead, attaque, bonusAttaque, defense, bonusDefense,  XP, maxXP, 
					previousXP, degat, soin,
